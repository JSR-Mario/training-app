...
describe('AnalyticsService', () => {
  ...
  it('should fetch exercise progress', () => {
    const mockResponse: ExerciseProgressEntry[] = [
      { sessionDate: '2023-01-01', weekNumber: 1, dayTemplateId: 'day-1', maxWeightKg: 100, maxWeightReps: 10, totalVolumeKg: 1000, bestSetVolumeWeightKg: 100, bestSetVolumeReps: 10, totalSets: 3 }
    ];
