...
export class ExerciseService {
  ...
  createExercise(data: { name: string; equipmentBrand?: string; unilateral: boolean; isPublic: boolean; spinalLoading?: boolean; isBodyweight?: boolean; type?: 'STRENGTH' | 'CARDIO' }): Observable<Exercise> {
    return this.http.post<Exercise>(this.BASE_URL, data);
  }

  updateExercise(id: string, data: { name: string; equipmentBrand?: string; unilateral: boolean; isPublic: boolean; spinalLoading?: boolean; isBodyweight?: boolean; type?: 'STRENGTH' | 'CARDIO' }): Observable<Exercise> {
