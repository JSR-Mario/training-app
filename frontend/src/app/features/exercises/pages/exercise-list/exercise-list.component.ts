        ...
        <div class="space-y-6 animate-in fade-in duration-500">
          ...
          @if (exercises().length === 0) {
            <div class="flex flex-col items-center justify-center py-16 px-4 bg-gray-50 dark:bg-gray-800/30 border border-gray-300 dark:border-gray-700 rounded-2xl border-dashed">
              <div class="w-16 h-16 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center mb-4 border border-gray-200 dark:border-gray-700">
              ...
              <p class="text-gray-500 dark:text-gray-400 text-center max-w-md">Get started by adding your first exercise to the catalog. You can organize them by body part targets.</p>
            </div>
          }
