    ...
    <form [formGroup]="searchForm" class="shrink-0 mb-4">
      ...
      <div class="relative">
        <input
          ...
          class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-accent-pos outline-none text-black dark:text-white pl-11 transition-all solid-input"
        >
