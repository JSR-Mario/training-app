    ...
    <div class="h-screen w-screen bg-gray-50 dark:bg-gray-950 flex flex-col md:flex-row overflow-hidden">
      ...
      >
        ...
        <div class="p-4 border-t border-gray-200 dark:border-gray-800 space-y-1">
          <a href="https://github.com/JSR-Mario/training-app/issues/new?template=bug_report.md" target="_blank" rel="noopener noreferrer" class="flex items-center px-4 py-3 text-sm text-gray-500 dark:text-gray-400 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-black dark:hover:text-white transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <span class="font-medium">Report a Bug</span>
          </a>
          <a href="https://github.com/JSR-Mario/training-app/issues/new?template=feature_request.md" target="_blank" rel="noopener noreferrer" class="flex items-center px-4 py-3 text-sm text-gray-500 dark:text-gray-400 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-black dark:hover:text-white transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
