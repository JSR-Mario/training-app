    ...
    <div class="h-screen w-screen bg-gray-50 dark:bg-gray-950 flex flex-col md:flex-row overflow-hidden">
      ...
      >
        ...
        <div class="p-4 border-t border-gray-200 dark:border-gray-800">
          <a routerLink="/" (click)="closeOnMobile()" class="flex items-center px-4 py-3 text-sm text-gray-500 dark:text-gray-400 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-black dark:hover:text-white transition-colors">
