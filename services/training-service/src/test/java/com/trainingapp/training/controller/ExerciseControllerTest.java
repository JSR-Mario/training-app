...
class ExerciseControllerTest {
    ...
    void createExercise_Success() throws Exception {
        ...
        ExerciseRequest req = new ExerciseRequest("Bench Press", "Hammer Strength", false, false, false, com.trainingapp.training.domain.ExerciseType.STRENGTH);
        ExerciseResponse resp = new ExerciseResponse(UUID.randomUUID(), "Bench Press", "Hammer Strength", false, false, false, com.trainingapp.training.domain.ExerciseType.STRENGTH, java.time.Instant.now(), java.util.Collections.emptyList(), 5.0);
    ...
    void searchExercises_Success() throws Exception {
        UUID userId = testUserId;
        ExerciseResponse resp = new ExerciseResponse(UUID.randomUUID(), "Bench Press", null, false, false, false, com.trainingapp.training.domain.ExerciseType.STRENGTH, java.time.Instant.now(), java.util.Collections.emptyList(), 5.0);
