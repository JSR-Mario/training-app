...
class DayExerciseControllerTest {
    ...
    void createDayExercise_Success() throws Exception {
        ...
        DayExerciseRequest req = new DayExerciseRequest(exerciseId, 3, 10, null, false, 1);
        DayExerciseResponse resp = new DayExerciseResponse(dayExerciseId, exerciseId, "Bench Press", null, false, 3, 10, null, 1, false, false, false);
