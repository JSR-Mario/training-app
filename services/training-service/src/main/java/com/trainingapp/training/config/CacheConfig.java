...
public class CacheConfig implements CachingConfigurer {
    ...
    private static final String CACHE_PREFIX = "training:cache:v1:";
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        return RedisCacheManager.builder(connectionFactory)
                ...
                .withCacheConfiguration("exercisesCatalog:global", config.entryTtl(Duration.ofHours(24)))
                .withCacheConfiguration("userExerciseProjections", config.entryTtl(Duration.ofMinutes(15)))
                .withCacheConfiguration("dashboardSummary", config.entryTtl(Duration.ofHours(1)))
                .build();
    }
